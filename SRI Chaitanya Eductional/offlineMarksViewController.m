...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath;
{
   ...
   cell.lbl_Testdt.text=[NSString stringWithFormat:@"TestDate : %@",[arr_Testdt objectAtIndex:indexPath.row]];
  cell.lbl_Testcode.text=[NSString stringWithFormat:@"TestCode : %@",[arr_Testcode objectAtIndex:indexPath.row]];
